...
function Main() {
  ...
  // categoryApi.getAll().then(respone => console.log(respone.data.data));
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div className="d-flex px-2 py-1">
                          <div>
                            <img src={ url + "/assets/admin/img/team-2.jpg"} className="avatar avatar-sm me-3" alt="user1" />
                          </div>
                      ...
                      <td className="align-middle">
                        <span className="text-secondary font-weight-bold text-xs" data-toggle="tooltip" role="button" data-original-title="Edit user">
                          Edit
                        </span>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div className="d-flex px-2 py-1">
                          <div>
                            <img src={ url + "/assets/admin/img/team-3.jpg"} className="avatar avatar-sm me-3" alt="user2" />
                          </div>
                          <div className="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex px-2 py-1">
                          <div>
                            <img src={ url + "/assets/admin/img/team-4.jpg"} className="avatar avatar-sm me-3" alt="user3" />
                          </div>
                          <div className="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex px-2 py-1">
                          <div>
                            <img src={ url + "/assets/admin/img/team-3.jpg"} className="avatar avatar-sm me-3" alt="user4" />
                          </div>
                          <div className="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex px-2 py-1">
                          <div>
                            <img src={ url + "/assets/admin/img/team-2.jpg"} className="avatar avatar-sm me-3" alt="user5" />
                          </div>
                          <div className="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex px-2 py-1">
                          <div>
                            <img src={ url + "/assets/admin/img/team-4.jpg"} className="avatar avatar-sm me-3" alt="user6" />
                          </div>
                          <div className="d-flex flex-column justify-content-center">
